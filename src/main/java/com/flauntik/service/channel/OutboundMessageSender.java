 ...
 * {@code WhatsAppService} based on the target tenant's configured provider.
 */
public interface OutboundMessageSender {

    Future<JsonObject> sendMessage(String tenantId, String to, String message);

    Future<JsonObject> sendMediaMessage(String tenantId, String to, String mediaUrl, String caption);
     ...
     */
    Future<JsonObject> sendTemplateMessage(String tenantId, String to, String templateId, Map<String, String> templateVariables);
}
